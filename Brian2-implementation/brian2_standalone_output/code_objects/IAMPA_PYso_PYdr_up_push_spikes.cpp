...
void _run_IAMPA_PYso_PYdr_up_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_IAMPA_PYso_PYdr_delay.size();
    ...
    #pragma omp parallel
    {
        IAMPA_PYso_PYdr_up.advance();
        IAMPA_PYso_PYdr_up.push(_ptr_array_PYso_group__spikespace, _ptr_array_PYso_group__spikespace[_num_spikespace-1]);
    }
