...
void _run_IGABAA_IN_IN_down_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_IGABAA_IN_IN_delay_1.size();
    ...
    #pragma omp parallel
    {
        IGABAA_IN_IN_down.advance();
        IGABAA_IN_IN_down.push(_ptr_array_IN_group__spikespace, _ptr_array_IN_group__spikespace[_num_spikespace-1]);
    }
