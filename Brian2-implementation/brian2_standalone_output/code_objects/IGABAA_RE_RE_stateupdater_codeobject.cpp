...
double* const _array_IGABAA_RE_RE_P_GABAA = _dynamic_array_IGABAA_RE_RE_P_GABAA.empty()? 0 : &_dynamic_array_IGABAA_RE_RE_P_GABAA[0];
const size_t _numP_GABAA = _dynamic_array_IGABAA_RE_RE_P_GABAA.size();
const size_t _numdt = 1;
const double mV = 0.001;
double* const _array_IGABAA_RE_RE_propoTauMult = _dynamic_array_IGABAA_RE_RE_propoTauMult.empty()? 0 : &_dynamic_array_IGABAA_RE_RE_propoTauMult[0];
const size_t _numpropoTauMult = _dynamic_array_IGABAA_RE_RE_propoTauMult.size();
...
double* const _array_IGABAA_RE_RE_tauGABAA = _dynamic_array_IGABAA_RE_RE_tauGABAA.empty()? 0 : &_dynamic_array_IGABAA_RE_RE_tauGABAA[0];
const size_t _numtauGABAA = _dynamic_array_IGABAA_RE_RE_tauGABAA.size();
...
const size_t _num_presynaptic_idx = _dynamic_array_IGABAA_RE_RE__synaptic_pre.size();
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_IGABAA_RE_RE_N = _array_IGABAA_RE_RE_N;
    double* __restrict  _ptr_array_IGABAA_RE_RE_P_GABAA = _array_IGABAA_RE_RE_P_GABAA;
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double* __restrict  _ptr_array_IGABAA_RE_RE_propoTauMult = _array_IGABAA_RE_RE_propoTauMult;
    double* __restrict  _ptr_array_IGABAA_RE_RE_sGABAA = _array_IGABAA_RE_RE_sGABAA;
    double* __restrict  _ptr_array_IGABAA_RE_RE_tauGABAA = _array_IGABAA_RE_RE_tauGABAA;
    ...
    const int _N = _array_IGABAA_RE_RE_N[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const int32_t _presynaptic_idx = _ptr_array_IGABAA_RE_RE__synaptic_pre[_idx];
        const double P_GABAA = _ptr_array_IGABAA_RE_RE_P_GABAA[_idx];
        const double propoTauMult = _ptr_array_IGABAA_RE_RE_propoTauMult[_idx];
        double sGABAA = _ptr_array_IGABAA_RE_RE_sGABAA[_idx];
        const double tauGABAA = _ptr_array_IGABAA_RE_RE_tauGABAA[_idx];
        ...
        sGABAA = _sGABAA;
        _ptr_array_IGABAA_RE_RE_sGABAA[_idx] = sGABAA;
