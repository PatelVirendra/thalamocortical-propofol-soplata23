...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses__synaptic_post.size();
    ...
    const double _lio_1 = 1.0f*(0.05 * siemens)/(_brian_pow(meter, 2));
    ...
    #pragma omp master
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double gPoisson_PYdr = _ptr_array_PYdr_group_gPoisson_PYdr[_postsynaptic_idx];
            gPoisson_PYdr += _lio_1;
            _ptr_array_PYdr_group_gPoisson_PYdr[_postsynaptic_idx] = gPoisson_PYdr;
