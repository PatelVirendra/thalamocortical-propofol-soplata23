...
void _run_INMDA_PYso_PYdr_down_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_INMDA_PYso_PYdr_delay_1.size();
    ...
    #pragma omp parallel
    {
        INMDA_PYso_PYdr_down.advance();
        INMDA_PYso_PYdr_down.push(_ptr_array_PYso_group__spikespace, _ptr_array_PYso_group__spikespace[_num_spikespace-1]);
    }
