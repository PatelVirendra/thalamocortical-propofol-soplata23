...
void _run_IAMPA_TC_PYdr_stateupdater_codeobject()
{
...
double* const _array_IAMPA_TC_PYdr_P_AMPA = _dynamic_array_IAMPA_TC_PYdr_P_AMPA.empty()? 0 : &_dynamic_array_IAMPA_TC_PYdr_P_AMPA[0];
const size_t _numP_AMPA = _dynamic_array_IAMPA_TC_PYdr_P_AMPA.size();
...
double* const _array_IAMPA_TC_PYdr_tauAMPA = _dynamic_array_IAMPA_TC_PYdr_tauAMPA.empty()? 0 : &_dynamic_array_IAMPA_TC_PYdr_tauAMPA[0];
const size_t _numtauAMPA = _dynamic_array_IAMPA_TC_PYdr_tauAMPA.size();
...
const size_t _num_presynaptic_idx = _dynamic_array_IAMPA_TC_PYdr__synaptic_pre.size();
    ...
    double* __restrict  _ptr_array_IAMPA_TC_PYdr_P_AMPA = _array_IAMPA_TC_PYdr_P_AMPA;
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double* __restrict  _ptr_array_IAMPA_TC_PYdr_sAMPA = _array_IAMPA_TC_PYdr_sAMPA;
    double* __restrict  _ptr_array_IAMPA_TC_PYdr_tauAMPA = _array_IAMPA_TC_PYdr_tauAMPA;
    ...
    const int _N = _array_IAMPA_TC_PYdr_N[0];
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const int32_t _presynaptic_idx = _ptr_array_IAMPA_TC_PYdr__synaptic_pre[_idx];
        const double P_AMPA = _ptr_array_IAMPA_TC_PYdr_P_AMPA[_idx];
        double sAMPA = _ptr_array_IAMPA_TC_PYdr_sAMPA[_idx];
        const double tauAMPA = _ptr_array_IAMPA_TC_PYdr_tauAMPA[_idx];
        const double v_pre = _ptr_array_TC_group_v[_presynaptic_idx];
        const double _sAMPA = (dt * (((P_AMPA * (1.0 - sAMPA)) * (1.0 + tanh(_lio_1 * v_pre))) - (1.0f*sAMPA/tauAMPA))) + sAMPA;
        sAMPA = _sAMPA;
        _ptr_array_IAMPA_TC_PYdr_sAMPA[_idx] = sAMPA;
