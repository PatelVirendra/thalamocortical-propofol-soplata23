...
void _run_IAMPA_PYso_IN_down_codeobject()
{
...
const size_t _numspike_activity = _dynamic_array_IAMPA_PYso_IN_spike_activity.size();
    ...
    #pragma omp parallel
    {
    std::vector<int> *_spiking_synapses = IAMPA_PYso_IN_down.peek();
        ...
        _spiking_synapse_idx++)
    {
        ...
        spike_activity = 0;
        _ptr_array_IAMPA_PYso_IN_spike_activity[_idx] = spike_activity;
...
void _debugmsg_IAMPA_PYso_IN_down_codeobject()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_IAMPA_PYso_IN__synaptic_pre.size() << endl;
}
