...
void _run_PYso_spikemon_codeobject()
{
...
int32_t* const _array_PYso_spikemon_i = _dynamic_array_PYso_spikemon_i.empty()? 0 : &_dynamic_array_PYso_spikemon_i[0];
const size_t _numi = _dynamic_array_PYso_spikemon_i.size();
double* const _array_PYso_spikemon_t = _dynamic_array_PYso_spikemon_t.empty()? 0 : &_dynamic_array_PYso_spikemon_t[0];
const size_t _numt = _dynamic_array_PYso_spikemon_t.size();
const size_t _num_source_idx = 100;
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_PYso_spikemon_N = _array_PYso_spikemon_N;
    double*   _ptr_array_defaultclock_t = _array_defaultclock_t;
    int32_t* __restrict  _ptr_array_PYso_group_i = _array_PYso_group_i;
    int32_t* __restrict  _ptr_array_PYso_group__spikespace = _array_PYso_group__spikespace;
    int32_t* __restrict  _ptr_array_PYso_spikemon_count = _array_PYso_spikemon_count;
    int32_t* __restrict  _ptr_array_PYso_spikemon_i = _array_PYso_spikemon_i;
    double* __restrict  _ptr_array_PYso_spikemon_t = _array_PYso_spikemon_t;
    int32_t* __restrict  _ptr_array_PYso_spikemon__source_idx = _array_PYso_spikemon__source_idx;


    //// MAIN CODE ////////////

    int32_t _num_events = _ptr_array_PYso_group__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_PYso_group__spikespace[_j];
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_PYso_group__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_PYso_group_i[_idx];
                const int32_t _to_record_i = _source_i;
                const double _to_record_t = _source_t;

                _dynamic_array_PYso_spikemon_i.push_back(_to_record_i);
                _dynamic_array_PYso_spikemon_t.push_back(_to_record_t);
                _ptr_array_PYso_spikemon_count[_idx-_source_start]++;
            }
            _ptr_array_PYso_spikemon_N[0] += _num_events;
        }
    }
...
void _debugmsg_PYso_spikemon_codeobject()
{
    using namespace brian;
    const size_t _numN = 1;
const size_t _num_clock_t = 1;
...
const size_t _num_source_idx = 100;
    ...
    std::cout << "Number of spikes: " << _ptr_array_PYso_spikemon_N[0] << endl;
}
