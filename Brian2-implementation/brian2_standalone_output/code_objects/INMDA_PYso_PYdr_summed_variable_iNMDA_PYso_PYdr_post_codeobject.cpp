...
void _run_INMDA_PYso_PYdr_summed_variable_iNMDA_PYso_PYdr_post_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    double* const _array_INMDA_PYso_PYdr_ENMDA = _dynamic_array_INMDA_PYso_PYdr_ENMDA.empty()? 0 : &_dynamic_array_INMDA_PYso_PYdr_ENMDA[0];
const size_t _numENMDA = _dynamic_array_INMDA_PYso_PYdr_ENMDA.size();
const size_t _numN = 1;
const int64_t N_post = 100;
double* const _array_INMDA_PYso_PYdr_Npost = _dynamic_array_INMDA_PYso_PYdr_Npost.empty()? 0 : &_dynamic_array_INMDA_PYso_PYdr_Npost[0];
const size_t _numNpost = _dynamic_array_INMDA_PYso_PYdr_Npost.size();
double* const _array_INMDA_PYso_PYdr_Npre = _dynamic_array_INMDA_PYso_PYdr_Npre.empty()? 0 : &_dynamic_array_INMDA_PYso_PYdr_Npre[0];
const size_t _numNpre = _dynamic_array_INMDA_PYso_PYdr_Npre.size();
...
double* const _array_INMDA_PYso_PYdr_gNMDA = _dynamic_array_INMDA_PYso_PYdr_gNMDA.empty()? 0 : &_dynamic_array_INMDA_PYso_PYdr_gNMDA[0];
const size_t _numgNMDA = _dynamic_array_INMDA_PYso_PYdr_gNMDA.size();
const size_t _numiNMDA_PYso_PYdr_post = 100;
double* const _array_INMDA_PYso_PYdr_radius = _dynamic_array_INMDA_PYso_PYdr_radius.empty()? 0 : &_dynamic_array_INMDA_PYso_PYdr_radius[0];
const size_t _numradius = _dynamic_array_INMDA_PYso_PYdr_radius.size();
char* const _array_INMDA_PYso_PYdr_remove_recurrent_bool = _dynamic_array_INMDA_PYso_PYdr_remove_recurrent_bool.empty()? 0 : &_dynamic_array_INMDA_PYso_PYdr_remove_recurrent_bool[0];
const size_t _numremove_recurrent_bool = _dynamic_array_INMDA_PYso_PYdr_remove_recurrent_bool.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_INMDA_PYso_PYdr__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_INMDA_PYso_PYdr_ENMDA = _array_INMDA_PYso_PYdr_ENMDA;
    int32_t*   _ptr_array_INMDA_PYso_PYdr_N = _array_INMDA_PYso_PYdr_N;
    double* __restrict  _ptr_array_INMDA_PYso_PYdr_Npost = _array_INMDA_PYso_PYdr_Npost;
    double* __restrict  _ptr_array_INMDA_PYso_PYdr_Npre = _array_INMDA_PYso_PYdr_Npre;
    int32_t* __restrict  _ptr_array_INMDA_PYso_PYdr__synaptic_post = _array_INMDA_PYso_PYdr__synaptic_post;
    double* __restrict  _ptr_array_INMDA_PYso_PYdr_gNMDA = _array_INMDA_PYso_PYdr_gNMDA;
    double* __restrict  _ptr_array_PYdr_group_iNMDA_PYso_PYdr = _array_PYdr_group_iNMDA_PYso_PYdr;
    double* __restrict  _ptr_array_INMDA_PYso_PYdr_radius = _array_INMDA_PYso_PYdr_radius;
    char* __restrict  _ptr_array_INMDA_PYso_PYdr_remove_recurrent_bool = _array_INMDA_PYso_PYdr_remove_recurrent_bool;
    ...
    {
        _ptr_array_PYdr_group_iNMDA_PYso_PYdr[_target_idx + 0] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_INMDA_PYso_PYdr_N[0]; _idx++)
    {
        // vector code
        const size_t _vectorisation_idx = _idx;
                
        const int32_t _postsynaptic_idx = _ptr_array_INMDA_PYso_PYdr__synaptic_post[_idx];
        const double ENMDA = _ptr_array_INMDA_PYso_PYdr_ENMDA[_idx];
        const double Npost = _ptr_array_INMDA_PYso_PYdr_Npost[_idx];
        const double Npre = _ptr_array_INMDA_PYso_PYdr_Npre[_idx];
        const double gNMDA = _ptr_array_INMDA_PYso_PYdr_gNMDA[_idx];
        const double radius = _ptr_array_INMDA_PYso_PYdr_radius[_idx];
        const char remove_recurrent_bool = _ptr_array_INMDA_PYso_PYdr_remove_recurrent_bool[_idx];
        const double res_NMDA = _ptr_array_INMDA_PYso_PYdr_res_NMDA[_idx];
        const double sNMDA = _ptr_array_INMDA_PYso_PYdr_sNMDA[_idx];
        ...
        _ptr_array_PYdr_group_iNMDA_PYso_PYdr[_ptr_array_INMDA_PYso_PYdr__synaptic_post[_idx]] += _synaptic_var;
    }
