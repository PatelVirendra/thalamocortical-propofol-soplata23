...
void _run_IGABAA_IN_IN_up_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_IGABAA_IN_IN_delay.size();
    ...
    #pragma omp parallel
    {
        IGABAA_IN_IN_up.advance();
        IGABAA_IN_IN_up.push(_ptr_array_IN_group__spikespace, _ptr_array_IN_group__spikespace[_num_spikespace-1]);
    }
