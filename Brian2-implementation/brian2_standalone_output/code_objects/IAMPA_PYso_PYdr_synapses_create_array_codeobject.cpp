...
int32_t* const _array_IAMPA_PYso_PYdr_N_incoming = _dynamic_array_IAMPA_PYso_PYdr_N_incoming.empty()? 0 : &_dynamic_array_IAMPA_PYso_PYdr_N_incoming[0];
const size_t _numN_incoming = _dynamic_array_IAMPA_PYso_PYdr_N_incoming.size();
int32_t* const _array_IAMPA_PYso_PYdr_N_outgoing = _dynamic_array_IAMPA_PYso_PYdr_N_outgoing.empty()? 0 : &_dynamic_array_IAMPA_PYso_PYdr_N_outgoing[0];
const size_t _numN_outgoing = _dynamic_array_IAMPA_PYso_PYdr_N_outgoing.size();
...
const size_t _num_synaptic_pre = _dynamic_array_IAMPA_PYso_PYdr__synaptic_pre.size();
...
const size_t _num_presynaptic_idx = _dynamic_array_IAMPA_PYso_PYdr__synaptic_pre.size();
    ...
    int32_t* __restrict  _ptr_array_IAMPA_PYso_PYdr_N_incoming = _array_IAMPA_PYso_PYdr_N_incoming;
    int32_t* __restrict  _ptr_array_IAMPA_PYso_PYdr_N_outgoing = _array_IAMPA_PYso_PYdr_N_outgoing;
    ...
    int32_t* __restrict  _ptr_array_IAMPA_PYso_PYdr_sources = _array_IAMPA_PYso_PYdr_sources;
    int32_t* __restrict  _ptr_array_IAMPA_PYso_PYdr_targets = _array_IAMPA_PYso_PYdr_targets;



const size_t _old_num_synapses = _ptr_array_IAMPA_PYso_PYdr_N[0];
const size_t _new_num_synapses = _old_num_synapses + _numsources;

const size_t _N_pre = N_pre;
const size_t _N_post = N_post;
_dynamic_array_IAMPA_PYso_PYdr_N_incoming.resize(_N_post + _target_offset);
_dynamic_array_IAMPA_PYso_PYdr_N_outgoing.resize(_N_pre + _source_offset);

for (size_t _idx=0; _idx<_numsources; _idx++) {
        
    const int32_t sources = _ptr_array_IAMPA_PYso_PYdr_sources[_idx];
    const int32_t targets = _ptr_array_IAMPA_PYso_PYdr_targets[_idx];
    const int32_t _real_sources = sources;
    const int32_t _real_targets = targets;


    _dynamic_array_IAMPA_PYso_PYdr__synaptic_pre.push_back(_real_sources);
    _dynamic_array_IAMPA_PYso_PYdr__synaptic_post.push_back(_real_targets);
    // Update the number of total outgoing/incoming synapses per source/target neuron
    _dynamic_array_IAMPA_PYso_PYdr_N_outgoing[_real_sources]++;
    _dynamic_array_IAMPA_PYso_PYdr_N_incoming[_real_targets]++;
}

// now we need to resize all registered variables
const size_t newsize = _dynamic_array_IAMPA_PYso_PYdr__synaptic_pre.size();
_dynamic_array_IAMPA_PYso_PYdr__synaptic_post.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr__synaptic_pre.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_alpha_AMPA.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_deprFactor.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_EAMPA.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_gAMPA.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_Npost.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_Npre.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_radius.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_remove_recurrent_bool.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_res_AMPA.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_sAMPA.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_spike_activity.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_tauAMPA.resize(newsize);
_dynamic_array_IAMPA_PYso_PYdr_tauRes_AMPA.resize(newsize);
// Also update the total number of synapses
_ptr_array_IAMPA_PYso_PYdr_N[0] = newsize;
