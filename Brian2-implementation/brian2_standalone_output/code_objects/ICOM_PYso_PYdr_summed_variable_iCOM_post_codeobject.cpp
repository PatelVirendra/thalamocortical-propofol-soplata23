...
double* const _array_ICOM_PYso_PYdr_gCOM = _dynamic_array_ICOM_PYso_PYdr_gCOM.empty()? 0 : &_dynamic_array_ICOM_PYso_PYdr_gCOM[0];
const size_t _numgCOM = _dynamic_array_ICOM_PYso_PYdr_gCOM.size();
const size_t _numiCOM_post = 100;
const size_t _numv_post = 100;
const size_t _numv_pre = 100;
const size_t _num_postsynaptic_idx = _dynamic_array_ICOM_PYso_PYdr__synaptic_post.size();
...
const size_t _num_presynaptic_idx = _dynamic_array_ICOM_PYso_PYdr__synaptic_pre.size();
    ///// POINTERS ////////////
    ...
    double* __restrict  _ptr_array_ICOM_PYso_PYdr_gCOM = _array_ICOM_PYso_PYdr_gCOM;
    ...
    {
        _ptr_array_PYdr_group_iCOM[_target_idx + 0] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_ICOM_PYso_PYdr_N[0]; _idx++)
    {
        // vector code
        const size_t _vectorisation_idx = _idx;
                
        const int32_t _postsynaptic_idx = _ptr_array_ICOM_PYso_PYdr__synaptic_post[_idx];
        const int32_t _presynaptic_idx = _ptr_array_ICOM_PYso_PYdr__synaptic_pre[_idx];
        const double gCOM = _ptr_array_ICOM_PYso_PYdr_gCOM[_idx];
        ...
        _ptr_array_PYdr_group_iCOM[_ptr_array_ICOM_PYso_PYdr__synaptic_post[_idx]] += _synaptic_var;
    }
