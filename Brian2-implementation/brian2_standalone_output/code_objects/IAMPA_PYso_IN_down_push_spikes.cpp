...
void _run_IAMPA_PYso_IN_down_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_IAMPA_PYso_IN_delay_1.size();
    ...
    #pragma omp parallel
    {
        IAMPA_PYso_IN_down.advance();
        IAMPA_PYso_IN_down.push(_ptr_array_PYso_group__spikespace, _ptr_array_PYso_group__spikespace[_num_spikespace-1]);
    }
