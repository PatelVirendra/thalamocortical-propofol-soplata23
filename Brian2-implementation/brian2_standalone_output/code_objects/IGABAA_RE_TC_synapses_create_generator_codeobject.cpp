...
int32_t* const _array_IGABAA_RE_TC_N_incoming = _dynamic_array_IGABAA_RE_TC_N_incoming.empty()? 0 : &_dynamic_array_IGABAA_RE_TC_N_incoming[0];
const size_t _numN_incoming = _dynamic_array_IGABAA_RE_TC_N_incoming.size();
int32_t* const _array_IGABAA_RE_TC_N_outgoing = _dynamic_array_IGABAA_RE_TC_N_outgoing.empty()? 0 : &_dynamic_array_IGABAA_RE_TC_N_outgoing[0];
const size_t _numN_outgoing = _dynamic_array_IGABAA_RE_TC_N_outgoing.size();
...
const size_t _num_synaptic_pre = _dynamic_array_IGABAA_RE_TC__synaptic_pre.size();
const int64_t _target_offset = 0;
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_IGABAA_RE_TC_N = _array_IGABAA_RE_TC_N;
    int32_t* __restrict  _ptr_array_IGABAA_RE_TC_N_incoming = _array_IGABAA_RE_TC_N_incoming;
    int32_t* __restrict  _ptr_array_IGABAA_RE_TC_N_outgoing = _array_IGABAA_RE_TC_N_outgoing;
    ...
    _dynamic_array_IGABAA_RE_TC_N_incoming.resize(_N_post + _target_offset);
    _dynamic_array_IGABAA_RE_TC_N_outgoing.resize(_N_pre + _source_offset);
    ...
    for(size_t _i=0; _i<_N_pre; _i++)
    {
        ...
        for(long _k=_uiter_low; _k<_uiter_high; _k+=_uiter_step)
        {
            ...
            for (size_t _repetition=0; _repetition<_n; _repetition++) {
                _dynamic_array_IGABAA_RE_TC_N_outgoing[_pre_idx] += 1;
                _dynamic_array_IGABAA_RE_TC_N_incoming[_post_idx] += 1;
                _dynamic_array_IGABAA_RE_TC__synaptic_pre.push_back(_pre_idx);
                _dynamic_array_IGABAA_RE_TC__synaptic_post.push_back(_post_idx);
			}
		}
	}

	// now we need to resize all registered variables
	const int32_t newsize = _dynamic_array_IGABAA_RE_TC__synaptic_pre.size();
    _dynamic_array_IGABAA_RE_TC__synaptic_post.resize(newsize);
    _dynamic_array_IGABAA_RE_TC__synaptic_pre.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_EGABAA.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_gGABAA.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_Npost.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_Npre.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_P_GABAA.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_propoCondMult.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_propoTauMult.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_sGABAA.resize(newsize);
    _dynamic_array_IGABAA_RE_TC_tauGABAA.resize(newsize);
	// Also update the total number of synapses
	_ptr_array_IGABAA_RE_TC_N[0] = newsize;
